...
public class DeclarationStep2Activity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration_step2);
    ...
    public void onClick(View view) {
        if(acknowledge.isChecked()){
            Intent intent = new Intent(getApplicationContext(), DeclarationStep3Activity.class);
