...
public class DeclarationStep3Activity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration_step3);
    ...
    public void onClick(View view) {
        if(acknowledge.isChecked()){
            Intent intent = new Intent(getApplicationContext(), DeclarationStep4Activity.class);
    ...
    public void onBackPressed(){
        Intent intent = new Intent(this, DeclarationStep2Activity.class);
        intent.putExtra("holder", holder);
        intent.putExtra("counsellor", counsellor);
        intent.putExtra("donorNumber", donorNumber);
        startActivity(intent);
