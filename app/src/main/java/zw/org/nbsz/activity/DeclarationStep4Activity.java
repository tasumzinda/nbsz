...
public class DeclarationStep4Activity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration_step4);
    ...
    public void onClick(View view) {
        if(acknowledge.isChecked()){
            Intent intent = new Intent(getApplicationContext(), DeclarationStep5Activity.class);
    ...
    public void onBackPressed(){
        Intent intent = new Intent(this, DeclarationStep3Activity.class);
        intent.putExtra("holder", holder);
        intent.putExtra("counsellor", counsellor);
        intent.putExtra("donorNumber", donorNumber);
        startActivity(intent);
